# FastWindow 0.1.0 [ALPHA-2026-06] — � Native Windows Window Engine for Java
...
For detailed instructions on compiling the C++ JNI code, see [COMPILE.md](docs/COMPILE.md).
